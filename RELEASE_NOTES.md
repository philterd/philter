...
Release entries for 4.0.0 and later are in [CHANGELOG.md](CHANGELOG.md), which is the source of
truth for them. This file keeps the narrative history of 3.x and earlier.
