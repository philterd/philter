...
public class FilterApiApiController extends AbstractApiController {
    ...
    @Autowired
    public FilterApiApiController(final PlainTextFilterService plainTextFilterService, final PdfFilterService pdfFilterService, final PolicyService policyService) {
