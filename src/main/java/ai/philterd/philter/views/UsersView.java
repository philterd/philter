...
public class UsersView extends AbstractRestrictedView {
    ...
    public UsersView(final MongoClient mongoClient, final EncryptionService encryptionService, final AuditEventPublisher auditEventPublisher,
        ...
        pageVerticalLayout.add(getTitle(("Users")));
